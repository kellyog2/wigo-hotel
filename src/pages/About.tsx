...
const About = () => {
  return (
    <section
      className="
        w-full py-24 transition duration-300
        bg-white text-black
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative">
            <img
              ...
              alt="Hotel"
              className="
                w-full h-[500px] object-cover rounded-3xl shadow-2xl
          ...
          <div>
            ...
            <p
              className="
                ...
                text-yellow-500 font-semibold mb-4
              "
            >
              About Us
            </p>
          ...
          {features.map((feature) => (
            <div
              ...
              className="
                ...
                bg-gray-100 border-yellow-500/20
                hover:border-yellow-500 hover:shadow-yellow-500/10

                dark:bg-gray-900 dark:border-yellow-500/20
