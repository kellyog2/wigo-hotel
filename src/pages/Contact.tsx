      ...
      <Container>
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <div className="space-y-8">
            ...
            {/* Address */}
            <div className="bg-gray-100 dark:bg-gray-900 border border-yellow-500/20 p-8 rounded-3xl shadow-sm flex items-start gap-5 hover:border-yellow-500 transition duration-300">
          ...
          {/* Contact Form */}
          <div className="bg-gray-100 dark:bg-gray-900 border border-yellow-500/20 p-8 md:p-10 rounded-3xl shadow-sm hover:border-yellow-500 transition duration-300">
